...
- **Every member has verdicted the current HEAD** and that verdict is happy. Not a previous HEAD. A fix push you have not had reviewed is the state this whole skill exists to keep from being called done.
