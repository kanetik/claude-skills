...
| `whole_change_taper` | `2` | How many **consecutive whole-change reads with no blocking finding** satisfy step 4's third convergence condition when the last of them sits behind HEAD. Counts reads, not rounds; a blocking finding in a whole-change read resets it to zero. See below. |
