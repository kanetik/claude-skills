...
Most state re-derives from the PR. Five pieces don't, and must be carried in the wake/continuation payload (in the common single-context run this is just in-memory and always available):
