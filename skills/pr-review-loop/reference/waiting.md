...
Most state re-derives from the PR. Four pieces don't, and must be carried in the wake/continuation payload (in the common single-context run this is just in-memory and always available):
